...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan  9 14:50:11 2019

@author: charlie

script to calculate 100 m local relief ONLY WITHIN each subbasin rather than
...
####up-front parameters
relief_window_size = 21 #100 m radius, 10 cells on each side of center
...
for basin in range(344): #will iterate [0,343] #344
    ...
    single_basin_relief_map = 'tmp_relief_' + str(basin)
...
#patched_rast = 'patched_local_relief'
#r.patch(input=unique_names_list, output=patched_rast)
...
#                 method=stats_list)
    ...
    #last thing: delete extra files not needed anymore
