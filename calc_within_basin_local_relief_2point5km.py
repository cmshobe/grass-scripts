...
script to calculate 2.5 km local relief ONLY WITHIN each subbasin rather than
...
####up-front parameters
relief_window_size = 501 #100 m radius, 10 cells on each side of center
...
for basin in range(344): #will iterate [0,343] #344
    ...
    single_basin_relief_map = 'tmp_2point5km_relief_' + str(basin)
