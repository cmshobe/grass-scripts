...
This script will clip and stitch together the 2.5 km relief tiles.
...
input_relief_tiles = ["'000-000_2point5km_relief'",
...
output_relief_tiles = ["'clipped_000-000_2point5km_relief'",
                "'clipped_000-001_2point5km_relief'",
                "'clipped_001-000_2point5km_relief'",
                "'clipped_001-001_2point5km_relief'",
                "'clipped_001-002_2point5km_relief'",
                "'clipped_001-003_2point5km_relief'",
                "'clipped_002-000_2point5km_relief'",
                "'clipped_002-001_2point5km_relief'",
                "'clipped_002-002_2point5km_relief'",
                "'clipped_002-003_2point5km_relief'",
                "'clipped_003-001_2point5km_relief'",
                "'clipped_003-002_2point5km_relief'",
                "'clipped_003-003_2point5km_relief'",
                "'clipped_004-002_2point5km_relief'",
                "'clipped_004-003_2point5km_relief'"]
...
for i in range(len(input_elev_tiles)):
    ...
    g.region(flags='p', n='n-5000', s='s+5000', 
             w='w+5000', e='e-5000')
...
#finally, mosaic all rasters together to make on 2.5 km window relief map
output_relief_tiles = ['clipped_000-000_2point5km_relief',
                'clipped_000-001_2point5km_relief',
                'clipped_001-000_2point5km_relief',
                'clipped_001-001_2point5km_relief',
...
mosaic_name = 'mosaic_2point5km_relief'
